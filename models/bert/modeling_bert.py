...
class BertLMPredictionHead(nn.Module):
  ...
  def forward(self, hidden_states):
    ...
    hidden_states = self.decoder(hidden_states) + torch.cat((self.bias, self.new_bias), dim=-1) # for [EOT] token
...
class BertForPreTraining(BertPreTrainedModel):
  ...
  def forward(self, input_ids, token_type_ids=None, attention_mask=None, masked_lm_labels=None,
    ...
    return outputs  # (masked_lm_loss, next_sentence_loss), prediction_scores, seq_relationship_score, (hidden_states), (attentions)
